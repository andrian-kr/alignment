...
## Social Chem 101
# traslate_csv(
#     file_path="../data/social-chem-101/social-chem-101_care-harm_rot-agree_4.csv",
#     source_column="action",
#     target_column="action_ukr",
#     ouput_file_path="../data/social-chem-101/social-chem-101_care-harm_4_deepl_translated.csv",
# )

## Ethics Commonsense
# traslate_csv(
#     file_path="../data/ethics/ethics_commonsense.csv",
#     source_column="input",
#     target_column="input_ukr",
#     ouput_file_path="../data/ethics/ethics_commonsense_deepl_translated.csv",
# )
